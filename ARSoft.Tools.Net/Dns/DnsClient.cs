...
namespace ARSoft.Tools.Net.Dns
{
    ...
    public class DnsClient : DnsClientBase, IDnsClient
    {
        ...
        public DnsClient(IPAddress dnsServer, int queryTimeout, int port = 53, bool ignoreInconclusiveDNSResolution = false)
            : this(new List<IPAddress> { dnsServer }, queryTimeout, port, ignoreInconclusiveDNSResolution) { }
        ...
        /// <param name="queryTimeout"> Query timeout in milliseconds </param>
        /// <param name="port"> Server port </param>
        public DnsClient(IEnumerable<IPAddress> dnsServers, int queryTimeout, int port = 53, bool ignoreInconclusiveDNSResolution = false)
