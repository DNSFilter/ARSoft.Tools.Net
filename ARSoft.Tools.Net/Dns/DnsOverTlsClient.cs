...
namespace ARSoft.Tools.Net.Dns
{
    ...
    public class DnsOverTlsClient : DnsOverTlsClientBase, IDnsClient
    {
        ...
        public DnsOverTlsClient(TlsUpstreamServer dnsServer, int queryTimeout, int port = 853, bool ignoreInconclusiveDNSResolution = false)
            : this(new List<TlsUpstreamServer> { dnsServer }, queryTimeout, port, ignoreInconclusiveDNSResolution) { }
        ...
        /// <param name="queryTimeout"> Query timeout in milliseconds </param>
        /// <param name="port"> Server port </param>
        public DnsOverTlsClient(IEnumerable<TlsUpstreamServer> dnsServers, int queryTimeout, int port = 853, bool ignoreInconclusiveDNSResolution = false)
            : base(dnsServers, queryTimeout, port, ignoreInconclusiveDNSResolution)
        {
            _logger = DnsfLogging.LoggerFactory.CreateLogger<DnsOverTlsClient>();
        }
        ...
        public static List<TlsUpstreamServer> GetLocalConfiguredDnsOverTlsServers()
        {
            ...
            // TODO: FUTURE: Some method to get local configured DNS-over-TLS servers
