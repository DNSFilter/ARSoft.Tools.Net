...
namespace ARSoft.Tools.Net.Dns
{
    public abstract class DnsOverTlsClientBase : DnsClientBase
    {
        ...
        internal DnsOverTlsClientBase(IEnumerable<TlsUpstreamServer> servers, int queryTimeout, int port, bool ignoreInconclusiveDNSResolution = false)
            : base(servers.Select(s => s.IPAddress).ToList(), queryTimeout, port, ignoreInconclusiveDNSResolution)
        {
            _logger = DnsfLogging.LoggerFactory.CreateLogger<DnsOverTlsClientBase>();
